...
model = nn.Sequential(dkm.Input(x_ind, learned=True),
                      dkm.F2G(),
                      #dkm.GramBatchNorm(i_norm="global", t_norm="global", i_scale="global", t_scale="global"),
                      #dkm.ReluKernel(),
                      dkm.NormalizedGaussianKernel(),
                      #dkm.SqExpKernel(),
                      dkm.GramLayer(x_ind.shape[0], args.dof, ncol_div=ncol_div),
                      #dkm.GramBatchNorm(i_norm="global", t_norm="global", i_scale="global", t_scale="global"),
                      # dkm.ReluKernel(),
                      dkm.NormalizedGaussianKernel(),
                      #dkm.SqExpKernel(),
...
#opt2 = NGD(V_params, lr=args.lr, momentum=0.9, weight_decay=1e-4, update_period=4)
